...
type ExceptionDateTime DateTime
...
func (e *ExceptionDateTime) EncodeICalName() (properties.PropertyName, error) {
	return properties.ExceptionDateTimesPropertyName, nil
}

func (e *ExceptionDateTime) EncodeICalParams() (string, error) {
	return (*DateTime)(e).EncodeICalValue()
}

// encodes exception date times property value for icalendar
func (e *ExceptionDateTime) EncodeICalValue() (string, error) {
	return (*DateTime)(e).EncodeICalValue()
}

// encodes exception date times property params for icalendar
func (e *ExceptionDateTime) DecodeICalParams(params properties.Params) error {
	return (*DateTime)(e).DecodeICalParams(params)
}

// decodes exception date times property value for icalendar
func (e *ExceptionDateTime) DecodeICalValue(value string) error {
	return (*DateTime)(e).DecodeICalValue(value)
}
